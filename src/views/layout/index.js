...
import MyNavTabs from './MyNavTabs';
import { getToken } from '@/utils/token';
import { getUserInfo, getAccessMemu } from 'service/login_api';
import { updateUserInfo, updateAccessMenu } from 'store/reducers/layout';
    ...
    return (
      <NLayout>
        ...
        <NLayout style={{background:'#fff'}}>
          ...
          <NContent style={{ padding: 24, background: '#fff' }}>
            <AppRouters />
          </NContent>
        </NLayout>
      </NLayout>
